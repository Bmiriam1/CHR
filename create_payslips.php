...
echo "Creating payslip data for CHR employees...\n";
...
if (!$program) {
    echo "No program found, using first available program...\n";
    $program = Program::first();
}

echo "Company: " . $company->name . "\n";
echo "Program: " . ($program ? $program->title : 'None') . "\n";
...
foreach ($employees as $employee) {
    foreach ($months as $month) {
        ...
        Payslip::create([
            ...
            'payroll_period_start' => $monthDate,
            'payroll_period_end' => $monthDate->endOfMonth(),
            'pay_date' => $monthDate->endOfMonth(),
