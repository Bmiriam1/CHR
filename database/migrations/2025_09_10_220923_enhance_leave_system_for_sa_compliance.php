...
return new class extends Migration
{
    ...
    {
        // Note: leave_types table already exists from previous migration
        ...
        // Note: leave_accruals and leave_carry_overs tables are created in separate migrations
