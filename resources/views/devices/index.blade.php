            ...
            <form method="GET" class="flex flex-wrap items-end gap-4">
                ...
                <div class="flex gap-2">
                    ...
                    @if(request()->hasAny(['search', 'status', 'platform']))
                        <a href="{{ route('devices.index') }}" class="btn border border-slate-300 font-medium text-slate-700 hover:bg-slate-150 focus:bg-slate-150 dark:border-navy-450 dark:text-navy-100 dark:hover:bg-navy-500 dark:focus:bg-navy-500">
                            Clear
                        </a>
                    @endif
                </div>
                        ...
                        <tr class="border-transparent hover:border-slate-200 dark:hover:border-navy-500">
                            ...
                            <td class="px-4 py-3 lg:px-5">
                                <div class="flex items-center space-x-2">
                                    <span class="rounded bg-slate-150 px-2 py-1 text-xs font-medium text-slate-800 dark:bg-navy-500 dark:text-navy-100">
                        ...
                        <tr>
                            <td colspan="6" class="px-4 py-8 text-center">
                                <div class="flex flex-col items-center justify-center space-y-3">
                                    <i class="fa-solid fa-mobile-screen-button text-4xl text-slate-300 dark:text-navy-400"></i>
                                    <p class="text-slate-600 dark:text-navy-200">No devices found</p>
                                    @if(request()->hasAny(['search', 'status', 'platform']))
                                        <a href="{{ route('devices.index') }}" class="text-primary hover:text-primary-focus">
                                            Clear filters
                                        </a>
                                    @endif
                                </div>
