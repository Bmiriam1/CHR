            ...
            <div class="card">
                ...
                <div class="p-4 sm:p-5">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <!-- Device Info -->
                        <div class="space-y-4">
                            <h4 class="text-base font-medium text-slate-700 dark:text-navy-100">Device Information</h4>
                    ...
                    @if($device->registration_notes)
                        <div class="mt-6 border-t border-slate-200 pt-6 dark:border-navy-500">
                            <h4 class="mb-2 text-base font-medium text-slate-700 dark:text-navy-100">Registration Notes</h4>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                @if($device->user->employee_number)
                                    <p class="text-xs text-slate-400 dark:text-navy-300">{{ $device->user->employee_number }}</p>
                                @endif
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-4">
                            @if($device->approved_at)
                                <div class="flex items-start space-x-3">
                                    <div class="mt-1 flex size-6 items-center justify-center rounded-full bg-success/10 text-success">
                            ...
                            @if($device->blocked_at)
                                <div class="flex items-start space-x-3">
                                    <div class="mt-1 flex size-6 items-center justify-center rounded-full bg-error/10 text-error">
...
<!-- Block Device Modal -->
<div id="blockDeviceModal" class="fixed inset-0 z-[100] flex flex-col items-center justify-center overflow-hidden px-4 py-6 opacity-0 sm:px-5" 
     style="display: none;">
    ...
    <div class="relative w-full max-w-lg origin-top rounded-lg bg-white transition-all duration-300 dark:bg-navy-700">
        <div class="flex items-center justify-between rounded-t-lg bg-slate-200 px-4 py-3 dark:bg-navy-800 sm:px-5">
            ...
            <button onclick="closeBlockModal()" class="btn -mr-1.5 size-7 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
...
<div id="deleteModal" class="fixed inset-0 z-[100] flex flex-col items-center justify-center overflow-hidden px-4 py-6 opacity-0 sm:px-5" 
     style="display: none;">
    <div class="absolute inset-0 bg-slate-900/60 transition-opacity duration-300"></div>
    <div class="relative w-full max-w-lg origin-top rounded-lg bg-white transition-all duration-300 dark:bg-navy-700">
        <div class="flex items-center justify-between rounded-t-lg bg-slate-200 px-4 py-3 dark:bg-navy-800 sm:px-5">
            ...
            <button onclick="closeDeleteModal()" class="btn -mr-1.5 size-7 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
                <i class="fa-solid fa-times"></i>
            </button>
        </div>
        <div class="px-4 py-4 sm:px-5">
