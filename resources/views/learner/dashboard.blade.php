            ...
            <div class="mt-6 grid grid-cols-1 gap-4 sm:gap-5 lg:grid-cols-3">
                ...
                <div class="space-y-4 sm:space-y-5">
                    ...
                    <div class="card">
                        ...
                        <div class="px-4 pb-4 sm:px-5">
                            <div class="space-y-3">
                                <a href="#" class="flex items-center justify-between rounded-lg bg-slate-100 p-3 transition-colors hover:bg-slate-200 dark:bg-navy-600 dark:hover:bg-navy-500">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <span class="text-sm font-medium">Download Payslip</span>
                                    </div>
                                ...
                                <a href="#" class="flex items-center justify-between rounded-lg bg-slate-100 p-3 transition-colors hover:bg-slate-200 dark:bg-navy-600 dark:hover:bg-navy-500">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <span class="text-sm font-medium">Tax Certificate</span>
                                    </div>
                                    <i class="fa fa-chevron-right text-xs text-slate-400"></i>
                                </a>
                            </div>
                            ...
                            <div class="space-y-4">
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-slate-400 dark:text-navy-300">
                                            HTML/CSS Fundamentals • 2 hours ago
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start space-x-3">
                                    <div class="mask is-squircle flex size-8 items-center justify-center bg-primary/10">
                                        <i class="fa fa-file text-primary text-xs"></i>
                                    </div>
                                    <div>
                                        <p class="text-sm font-medium text-slate-700 dark:text-navy-100">
                                            Payslip generated
                                ...
                                <div class="flex items-start space-x-3">
                                    <div class="mask is-squircle flex size-8 items-center justify-center bg-warning/10">
                                        <i class="fa fa-calendar text-warning text-xs"></i>
                                    </div>
                                    <div>
                                        <p class="text-sm font-medium text-slate-700 dark:text-navy-100">
                                            Schedule updated
